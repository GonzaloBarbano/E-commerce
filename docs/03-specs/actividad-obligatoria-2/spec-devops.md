...
*(Esta sección se completará al final del sprint con la evidencia y prompts usados)*
- [ ] Code Review 1: Pendiente
- [ ] Code Review 2: Pendiente
- [ ] Code Review 3: Pendiente
- [ ] Code Review 4: Pendiente

## 4. Obstáculos y Resoluciones
*(Se documentarán los problemas encontrados en el flujo y cómo se resolvieron)*
