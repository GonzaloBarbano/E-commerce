...
- [fix/coord-devops-spec-devops] Resolución de RC29 × 6: reescritura completa de `spec-devops.md` tras la baja de @GonzaloBarbano del grupo el 22/06/2026. Documentación honesta de 4 code reviews (1 real de Gonza + 2 retroactivos + 1 validación cruzada), 4 obstáculos registrados (incluida la baja del integrante), métricas reales y doble firma del rol.
